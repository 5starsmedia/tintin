export default
  ...
  function NewsPostModel($resource) {
    var resource = $resource('/api/posts/:_id/:method', {
      ...
      'get': {method: 'GET', params: { fields: 'id,title,alias,body,category,status,tags,source,files,coverFile,createDate,isAllowComments,photoSource,ownPhoto,isTop,isHighlight,meta,keywords,keywordGroup' }},
      'save': {method: 'PUT'},
      'create': {method: 'POST'},
