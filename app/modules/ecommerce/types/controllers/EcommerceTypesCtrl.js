export default
class EcommerceTypesCtrl {
  /*@ngInject*/
  constructor($scope, $state, $filter, $stateParams, EcommerceTypeModel) {

    $scope.loading = true;
    $scope.editedItem = { _id: null };

    var loadData = () => {
      EcommerceTypeModel.getTree(function (res) {
        $scope.loading = false;
        $scope.tree = res;
      });
    };
    ...
    $scope.setActive = function(item) {
      ...
      $state.go('ecommerce.types.edit', { id: item._id });
    }
  }
}