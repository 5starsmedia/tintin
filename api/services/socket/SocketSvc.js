...
SocketSvc.prototype.init = function (next) {
  ...
  self.io.on('connection', function (socket) {
    ...
    socket.onevent = function(packet) {
      ...
      self.app.services.broadcast.publish('socket:' + args[0], {account: socket.account, endpoint: socket.handshake.headers['x-forwarded-for'] || socket.handshake.address, event: args[0], data: args[1] });
    };
