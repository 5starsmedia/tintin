/**
 * @module common.validators.strainFlavors
...
(function () {
  ...
  var validators = {
    'strainFlavors.put': function (modelState, next) {
    ...
    'strainFlavors.post': function (modelState, next) {
  ...
  if (typeof window !== 'undefined' && window.angular) {
    window.angular.module('common.validators.strainFlavors', ['services.validationSvc']).run(['validationSvc', function (validationSvc) {
